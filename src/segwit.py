...
# Send 4.9999 BTC to B, leaving 0.0001 BTC as implied fee to avoid the max fee error
inputs_ab = [{"txid": utxo_a["txid"], "vout": utxo_a["vout"]}]
outputs_ab = {addr_b: 4.9999}
...
# B has 4.9999. Send 4.9998 to C, leaving 0.0001 BTC as implied fee
inputs_bc = [{"txid": utxo_b["txid"], "vout": utxo_b["vout"]}]
outputs_bc = {addr_c: 4.9998}
